...
int main(int argc, char *argv[])
{
    ...
    if (mm_read_banner(mmInputFile, &matcode) != 0)
    {
        printf(ANSI_COLOR_RED   "Could not process Matrix Market file.\nEnsure file is correctly formatted and does not use gz/zip compression.\n" ANSI_COLOR_RESET);
        exit(1);
    }
