                               ...
                               double **val_, int **I_, int **J_)
{
    ...
    *nz_ = nz;
    ...
    I = (int *)malloc((size_t)nz * sizeof(int));
    J = (int *)malloc((size_t)nz * sizeof(int));
    val = (double *)malloc((size_t)nz * sizeof(double));
                    ...
                    double **val, MM_typecode *matcode)
{
    ...
    *I = (int *)malloc((long unsigned int)*nz * sizeof(int));
    *J = (int *)malloc((long unsigned int)*nz * sizeof(int));
    *val = NULL;

    if (mm_is_complex(*matcode))
    {
        *val = (double *)malloc((long unsigned int)*nz * 2 * sizeof(double));
    ...
    {
        *val = (double *)malloc((long unsigned int)*nz * sizeof(double));
        ret_code = mm_read_mtx_crd_data(f, *nz, *I, *J, *val,
                                        *matcode);
        if (ret_code != 0)
            return ret_code;
